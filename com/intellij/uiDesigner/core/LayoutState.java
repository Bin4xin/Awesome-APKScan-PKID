...
public final class LayoutState {
    ...
    public LayoutState(GridLayoutManager layout, boolean ignoreInvisibleComponents) {
        ...
        List<Component> componentsList = new ArrayList<>(layout.getComponentCount());
        List<GridConstraints> constraintsList = new ArrayList<>(layout.getComponentCount());
        ...
        this.myConstraints = constraintsList.toArray(new GridConstraints[0]);
